            ...
            <Modal.Body>
                <Form>
                    <Form.Group controlId='title'>
                        ...
                        <Form.Control type='text' value = 'New Title' onChange={e => setTitle(e.target.value)} />
                    </Form.Group>

                    <Form.Group controlId='description'>
                        <Form.Label>Description</Form.Label>
                        <Form.Control type='text' value = 'New Description' onChange={e => setDescription(e.target.value)} />
                    </Form.Group>
